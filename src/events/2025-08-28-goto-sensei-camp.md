	...
	<article class="content-wrapper">
		...
		<ol class="list list--unstyled schedule">
			<li>
				...
				<ul class="list list--indent">
					<li>1 pm&ndash;10 pm: Accommodation Check-in</li>
				</ul>
			</li>
			<li>
				...
				<ul class="list list--indent">
					...
					<li>9 am&ndash;12 noon: Morning Seminar at Redhawk Activity Court</li>
					<li>12 noon&ndash;12:45 pm: Lunch</li>
					<li>1 pm&ndash;4 pm: Afternoon Seminar at Redhawk Activity Court</li>
